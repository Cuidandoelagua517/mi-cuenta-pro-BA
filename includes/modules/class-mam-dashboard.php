...
class MAM_Dashboard {
    ...
    public function __construct() {
        ...
        add_action('woocommerce_account_dashboard', array($this, 'dashboard_content'), 5);
    ...
    public function dashboard_content() {
        // Comprobar si el dashboard personalizado está activado
        ...
        if ($enable_custom_dashboard) {
            ...
            // Cargar el template personalizado del dashboard
            wc_get_template(
                'myaccount/dashboard.php',
                array(),
                '',
                MAM_PLUGIN_DIR . 'templates/'
            );
        }
    }
